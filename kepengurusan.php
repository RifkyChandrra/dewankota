    ...
    <div class="container">
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                echo "<div class='col-lg-3 col-md-6 single-blog' style='margin-top: " . ($counter >= 4 ? '20px' : '0') . ";'>";
                // Menampilkan foto dengan link ke halaman detail
                echo "<a href='kepengurusan-detail.php?id=" . $row['id'] . "'><img class='img-fluid' src='img/" . $row['foto'] . "' alt=''></a>";
                echo "<p class='date'>" . $row['pekerjaan'] . "</p>";
